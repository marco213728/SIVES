...
export const ThumbsUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props} strokeWidth={1} fill="currentColor">
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 00-9 0m9 0a9.094 9.094 0 01-9 0m9 0v-2.647a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v2.647m9 0a9.094 9.094 0 01-9 0M18 18.72v-2.647a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v2.647m-9 0a9.094 9.094 0 009 0m-9 0a9.094 9.094 0 019 0" />
    </Icon>
);
...
export const ShieldCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M12 21.75c2.426 0 4.71-.849 6.474-2.311.536-.44.974-.943 1.375-1.486 1.042-1.36 1.651-3.033 1.651-4.814 0-5.46-3.953-10.038-9.5-11.162A1.87 1.87 0 0 0 10.5 3.375V2.25a.75.75 0 0 0-.75-.75h-1.5a.75.75 0 0 0-.75.75v1.125c0 .615.352 1.157.876 1.428-5.547 1.124-9.5 5.702-9.5 11.162 0 1.78.609 3.454 1.651 4.814.401.543.839 1.046 1.375 1.486C7.29 20.9 9.574 21.75 12 21.75Z" />
  </Icon>
);
...
export const OfficeBuildingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6h1.5m-1.5 3h1.5m-1.5 3h1.5M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M11.25 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21" />
    </Icon>
);

export const ColorSwatchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM12 11v3.5a2.5 2.5 0 005 0V11" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11v3.5a2.5 2.5 0 01-5 0V11" />
    </Icon>
);
